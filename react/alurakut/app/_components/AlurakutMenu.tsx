// ARQUIVO: app/_components/AlurakutMenu.tsx

"use client"; // Necessário porque usa 'useState' para o menu mobile
...
// -----------------------------------------------------------------
// Componente <Link> atualizado para o Next.js 14+
// (Ele não usa mais um <a> por dentro)
// -----------------------------------------------------------------
  ...
  return (
    <AlurakutMenuWrapper $isMenuOpen={isMenuOpen}>
      <div className="container">
        <AlurakutMenuLogo src={`${BASE_URL}/logo.svg`} alt="test"/>
...
function AlurakutMenuProfileSidebar({ githubUser }: ProfileSidebarProps) {
  return (
    <div className="alurakutMenuProfileSidebar">
      <div>
          <ProfileImage src={`https://github.com/${githubUser}.png`} alt="test" />
          <hr />
          <p>
...
// =================================================================
// Sub-componente: Menu da Sidebar
// =================================================================
...
const AlurakutMenuWrapper = styled.header<{ $isMenuOpen: boolean }>`
  width: 100%;
